...
public class IpFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        HttpServletResponse httpReq = (HttpServletRequest) request;
        HttpServletResponse httpRes = (HttpServletResponse) response;
        HttpSession session = httpReq.getSession();
        
        Stirng ip = httpReq.getRemoteAddr();
        StringTokenizer toke = new StringTokenizer(ip,".");
        String IP_RANGE = "192.168.1";
        int dots = 0;
        String byte1 = "";
        String byte2 = "";
        String byte3 = "";
        ...
        try {
            ...
            range = byt1 + "." + byte2 + "." + byte3;
            if (IP_RANGE.equals(range)){
            chain.doFilter(request, response);
            }
            else {
                System.out.println("Dear " + username + ", " + ip + "IP address is not accepted!");
                httpReq.sendRedirect("IP.jsp");
            }
        } catch (Throwable t) {
